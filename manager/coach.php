...
$sql = "SELECT users.*,country.country_name  as country FROM users  JOIN country ON users.country_id = country.id WHERE user_type_id = 3 and add_by = $related_user order by users.id DESC";
                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="coach.php">Coachs</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body card-dashboard">
                                <a href="coach_add.php" class="btn btn-primary mb-2 waves-effect waves-light"><i class="feather icon-plus"></i>&nbsp; Add New Coach</a>
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="coach_edit.php?id=<?php echo $data['id']; ?>" type="button" class="btn bg-gradient-info waves-effect waves-light">Edit</a>
                                                        <a href="coach_delete.php?id=<?php echo $data['id']; ?>" type="button" class="btn bg-gradient-danger waves-effect waves-light">Delete</a>
