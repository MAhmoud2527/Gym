...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        // First Query
        $sql = "INSERT INTO `users`(`username`, `email`, `password`, `phone`, `photo`, `country_id`, `user_type_id` , `add_by`) VALUES ('$name' , '$email' , '$password', $phone , '$finalName',  $country , 4 , $related_user)";
        $result = mysqli_query($conn, $sql);
        $last_id = mysqli_insert_id($conn);

        // Second Query 
        $sql2 = "INSERT INTO `trainees_more_info`(`weight`, `height`, `package_id`, `coach_id` , `more_info` , `more_add_by`)  VALUES ($weight , $height , $package  , $coach , $last_id  , $related_user)";
                                ...
                                <form class="form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-label-group">
                                                    <input type="number" id="first-name-column" class="form-control" placeholder="Weight" name="weight">
                                            ...
                                            <div class="col-12">
                                                <div class="form-label-group">
                                                    <input type="number" id="last-name-column" class="form-control" placeholder="Height" name="height">
                                            ...
                                            <div class="col-12">
                                                <div class="form-label-group">
                                                    ...
                                                    <select class="select2-theme form-control" id="select2-theme2" name="package">
                                                        ...
                                                        <?php
                                                        // Select Data for drobdown Menu
                                                        $query = "SELECT * FROM `package` where add_by = $related_user";
                                                        $result = mysqli_query($conn, $query);
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                        ?>
