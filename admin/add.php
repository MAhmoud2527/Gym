...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        // insert data
        $sql = "INSERT INTO `users`(`username`, `email`, `password`, `phone`, `photo`, `country_id`, `user_type_id` , `add_by`) VALUES ('$name' , '$email' , '$password', $phone , '$finalName',  '$country' , 2 , $related_user)";
