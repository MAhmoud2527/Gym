                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="view.php">Exercises</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-body card-dashboard">
                                <a href="add.php" class="btn btn-primary mb-2 waves-effect waves-light"><i class="feather icon-plus"></i>&nbsp; Add New Exercise</a>
                                    ...
                                    <table class="table
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) { ?>
                                                <tr>
                                                    <td><?php echo $i++ ?></td>
                                                    <td><?php echo $data['exercises_name'] ?></td>
                                                    <td><?php echo $data['sets'] . "Set" ?></td>
